# This script is a modified copy of the original script in fsqc python package v2.1.1
# It contains functions that are needed for the QC of FreeSurfer outputs
# The modified part concerns the function called
# outlierDetection() -> outlierDetection_normalized()
...
"""
Adapted from fsqc.outlierDetection.py
